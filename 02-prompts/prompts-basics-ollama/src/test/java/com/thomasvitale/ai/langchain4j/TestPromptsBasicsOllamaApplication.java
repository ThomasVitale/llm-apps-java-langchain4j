...
public class TestPromptsBasicsOllamaApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(PromptsBasicsOllamaApplication::main).with(TestPromptsBasicsOllamaApplication.class).run(args);
    }
